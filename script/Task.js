class Task {
  ...
  renderTask() {
    ...
    this._buttonElementDelete = this._element.querySelector(
      ".task__button_type_delete"
    );
    this._buttonElementCopy = this._element.querySelector(
      ".task__button_type_copy"
    );
